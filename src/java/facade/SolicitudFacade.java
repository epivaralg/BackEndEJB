...
public class SolicitudFacade extends AbstractFacade<Solicitud> {
    ...
    public boolean isHistoriaEstadoCollectionEmpty(Solicitud entity) {
        ...
        cq.select(cb.literal(1L)).distinct(true).where(cb.equal(solicitud, entity), cb.isNotEmpty(solicitud.get(Solicitud_f.historiaEstadoCollection)));
    ...
    public boolean isRutaCollectionEmpty(Solicitud entity) {
        ...
        CriteriaQuery<Long> cq = cb.createQuery(Long.class);
        Root<Solicitud> solicitud = cq.from(Solicitud.class);
        cq.select(cb.literal(1L)).distinct(true).where(cb.equal(solicitud, entity), cb.isNotEmpty(solicitud.get(Solicitud_f.rutaCollection)));
        return em.createQuery(cq).getResultList().isEmpty();
    }
    ...
    public boolean isIdUsuarioAprobadorEmpty(Solicitud entity) {
        ...
        CriteriaQuery<Long> cq = cb.createQuery(Long.class);
        Root<Solicitud> solicitud = cq.from(Solicitud.class);
        cq.select(cb.literal(1L)).distinct(true).where(cb.equal(solicitud, entity), cb.isNotNull(solicitud.get(Solicitud_f.idUsuarioAprobador)));
        return em.createQuery(cq).getResultList().isEmpty();
    }
    ...
    public boolean isIdComisionEmpty(Solicitud entity) {
        ...
        CriteriaQuery<Long> cq = cb.createQuery(Long.class);
        Root<Solicitud> solicitud = cq.from(Solicitud.class);
        cq.select(cb.literal(1L)).distinct(true).where(cb.equal(solicitud, entity), cb.isNotNull(solicitud.get(Solicitud_f.idComision)));
        return em.createQuery(cq).getResultList().isEmpty();
    }
    ...
    public boolean isIdUsuarioGestorEmpty(Solicitud entity) {
        ...
        CriteriaQuery<Long> cq = cb.createQuery(Long.class);
        Root<Solicitud> solicitud = cq.from(Solicitud.class);
        cq.select(cb.literal(1L)).distinct(true).where(cb.equal(solicitud, entity), cb.isNotNull(solicitud.get(Solicitud_f.idUsuarioGestor)));
        return em.createQuery(cq).getResultList().isEmpty();
    }
    ...
    public boolean isIdTipoComisionEmpty(Solicitud entity) {
        ...
        CriteriaQuery<Long> cq = cb.createQuery(Long.class);
        Root<Solicitud> solicitud = cq.from(Solicitud.class);
        cq.select(cb.literal(1L)).distinct(true).where(cb.equal(solicitud, entity), cb.isNotNull(solicitud.get(Solicitud_f.idTipoComision)));
        return em.createQuery(cq).getResultList().isEmpty();
    }
    ...
    public boolean isIdTipoUsoVehiculoEmpty(Solicitud entity) {
        ...
        CriteriaQuery<Long> cq = cb.createQuery(Long.class);
        Root<Solicitud> solicitud = cq.from(Solicitud.class);
        cq.select(cb.literal(1L)).distinct(true).where(cb.equal(solicitud, entity), cb.isNotNull(solicitud.get(Solicitud_f.idTipoUsoVehiculo)));
        return em.createQuery(cq).getResultList().isEmpty();
    }
    ...
    public boolean isIdUsuarioEmpty(Solicitud entity) {
        ...
        CriteriaQuery<Long> cq = cb.createQuery(Long.class);
        Root<Solicitud> solicitud = cq.from(Solicitud.class);
        cq.select(cb.literal(1L)).distinct(true).where(cb.equal(solicitud, entity), cb.isNotNull(solicitud.get(Solicitud_f.idUsuario)));
        return em.createQuery(cq).getResultList().isEmpty();
    }
