...
public class TipoBitacoraFacade extends AbstractFacade<TipoBitacora> {
    ...
    public boolean isBitacoraCollectionEmpty(TipoBitacora entity) {
        ...
        cq.select(cb.literal(1L)).distinct(true).where(cb.equal(tipoBitacora, entity), cb.isNotEmpty(tipoBitacora.get(TipoBitacora_f.bitacoraCollection)));
