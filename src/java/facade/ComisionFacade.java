...
public class ComisionFacade extends AbstractFacade<Comision> {
    ...
    public boolean isIdPilotoEmpty(Comision entity) {
        ...
        cq.select(cb.literal(1L)).distinct(true).where(cb.equal(comision, entity), cb.isNotNull(comision.get(Comision_f.idPiloto)));
    ...
    public boolean isIdTipoComisionEmpty(Comision entity) {
        ...
        CriteriaQuery<Long> cq = cb.createQuery(Long.class);
        Root<Comision> comision = cq.from(Comision.class);
        cq.select(cb.literal(1L)).distinct(true).where(cb.equal(comision, entity), cb.isNotNull(comision.get(Comision_f.idTipoComision)));
        return em.createQuery(cq).getResultList().isEmpty();
    }
    ...
    public boolean isPlacaEmpty(Comision entity) {
        ...
        CriteriaQuery<Long> cq = cb.createQuery(Long.class);
        Root<Comision> comision = cq.from(Comision.class);
        cq.select(cb.literal(1L)).distinct(true).where(cb.equal(comision, entity), cb.isNotNull(comision.get(Comision_f.placa)));
        return em.createQuery(cq).getResultList().isEmpty();
    }
    ...
    public boolean isSolicitudCollectionEmpty(Comision entity) {
        ...
        CriteriaQuery<Long> cq = cb.createQuery(Long.class);
        Root<Comision> comision = cq.from(Comision.class);
        cq.select(cb.literal(1L)).distinct(true).where(cb.equal(comision, entity), cb.isNotEmpty(comision.get(Comision_f.solicitudCollection)));
        return em.createQuery(cq).getResultList().isEmpty();
    }
