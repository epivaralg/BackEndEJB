...
public class TipoVehiculoFacade extends AbstractFacade<TipoVehiculo> {
    ...
    public boolean isVehiculoCollectionEmpty(TipoVehiculo entity) {
        ...
        cq.select(cb.literal(1L)).distinct(true).where(cb.equal(tipoVehiculo, entity), cb.isNotEmpty(tipoVehiculo.get(TipoVehiculo_f.vehiculoCollection)));
