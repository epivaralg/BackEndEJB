...
public class TipoComisionFacade extends AbstractFacade<TipoComision> {
    ...
    public boolean isComisionCollectionEmpty(TipoComision entity) {
        ...
        cq.select(cb.literal(1L)).distinct(true).where(cb.equal(tipoComision, entity), cb.isNotEmpty(tipoComision.get(TipoComision_f.comisionCollection)));
