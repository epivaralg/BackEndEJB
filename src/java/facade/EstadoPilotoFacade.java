...
public class EstadoPilotoFacade extends AbstractFacade<EstadoPiloto> {
    ...
    public boolean isPilotoCollectionEmpty(EstadoPiloto entity) {
        ...
        cq.select(cb.literal(1L)).distinct(true).where(cb.equal(estadoPiloto, entity), cb.isNotEmpty(estadoPiloto.get(EstadoPiloto_f.pilotoCollection)));
